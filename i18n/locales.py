...
STRINGS = {
    "en": {
        ...
        "quick_access": "Shortcut in side menu",
        "quick_access_sub": "Add «Shortcuts» directly to the side menu",
        "select_setting": "Pick a setting to control",
        "choose_value": "Pick value",
        "text_value": "Value",
        "save": "Save",
        "cancel": "Cancel",
        "auto_remove_missing": "Auto-clean shortcuts",
        "auto_remove_missing_sub": "Delete shortcuts if the plugin was uninstalled",
        "missing_shortcuts_removed": "Cleaned up shortcuts",
    ...
    "ru": {
        ...
        "quick_access": "Ярлыки в боковом меню",
        "quick_access_sub": "Показывать пункт «Ярлыки» в главном боковом меню",
        ...
        "auto_remove_missing": "Автоочистка ярлыков",
